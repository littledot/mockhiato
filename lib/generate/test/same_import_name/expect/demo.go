...
import (
	"github.com/littledot/mockhiato/lib/generate/test/same_import_name/expect/same"
	other_same "github.com/littledot/mockhiato/lib/generate/test/same_import_name/expect/same1"
)
