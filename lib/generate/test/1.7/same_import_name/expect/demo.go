...
import (
	"github.com/littledot/mockhiato/lib/generate/test/1.7/same_import_name/expect/same"
	other_same "github.com/littledot/mockhiato/lib/generate/test/1.7/same_import_name/expect/same1"
)
